...
namespace LinkCrawler.Utils.Helpers
{
    public static class MarkupHelpers
    {
        ...
        /// <summary>
        /// Gets a list of all urls in markup and tries to fix the urls that httprequest will have a problem with 
        /// (i.e relative urls, urls with no scheme, mailto links..etc)
        /// </summary>
        /// <returns>List of urls that will work with httprequest for sending http get</returns>
